def ConsoleColor(text, fcolor=False, bcolor=False, h=False, u=False, s=False, f=False):
    ...
    :return: 返回样式设置
    """
    fcdict = {'white': '30', 'red': '31', 'green': '32', 'yellow': '33', 'blue': '34', 'purple': '35', 'turquoise': '36', 'gray': '73'}
    bcdict = {'white': '40', 'red': '41', 'green': '42', 'yellow': '43', 'blue': '44', 'purple': '45', 'turquoise': '46', 'gray': '47'}
    style = ''
    style_list=[]
